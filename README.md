...
Текущий этап проекта: витрина React с каталогом из PostgreSQL, сохраняемой гостевой корзиной и рабочей авторизацией по одноразовому коду. Модели заказов и платежей также подготовлены в отдельной БД.
...
- **Каталог:** товары, фотографии, размерные варианты, SKU и остатки в `catalog_db`; цены хранятся целым числом копеек.
...
1. Админка: управление товарами, фотографиями, размерами, остатками и ценами; роли и аудит действий.
