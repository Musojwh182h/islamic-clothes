...
Текущий этап проекта: витрина React с каталогом из PostgreSQL, сохраняемой гостевой корзиной, авторизацией по одноразовому коду, оформлением заказов в PostgreSQL, media-сервисом для товарных изображений в MinIO и отдельной админкой. Администратор управляет товарами, размерами, остатками и статусами заказов.
